...
RSpec.describe Blackjack do
  ...
  describe 'standing' do
    ...
    it "'Dealer' automatically hits if value < 17 and first card face up" do
      # Player cards
      card1 = Card.new('Clubs', '10')
      card2 = Card.new('Hearts', '10')
      card3 = Card.new('Diamonds', 'Ace')
  ...
  describe 'setting results' do
    it 'sets the correct result when player bust' do
      # Player cards
      card1 = Card.new('Clubs', '10')
      card2 = Card.new('Hearts', '10')
      card3 = Card.new('Diamonds', '2')
    ...
    it 'sets the correct result when dealer bust' do
      # Player cards
      card1 = Card.new('Clubs', '10')
      card2 = Card.new('Hearts', '10')
      card3 = Card.new('Diamonds', 'Ace')
    ...
    it 'sets the correct result when there it a tie' do
      # Player cards
      card1 = Card.new('Clubs', '10')
      card2 = Card.new('Hearts', '10')
      card3 = Card.new('Diamonds', 'Ace')
